...
class ReservationTimeRepositoryTest {
    ...
    void getAll_ShouldReturnAllReservations_WhenHasNoException() {
        ...
        final var sut = reservationTimeRepository.getAll().get(0);

        Assertions.assertThat(sut).isEqualTo(new ReservationTime(1, LocalTime.of(2, 2)));
    }
    ...
    void remove_ShouldDeleteStoredDate_WhenHasNoException() {
        ...
        // Then
        Assertions.assertThat(reservationTimeRepository.getAll()).isEmpty();
    }

    @Test
    @DisplayName("예약 단건 조회")
    void get_ShouldReturnOneReservation_WhenHasId() {
        final var storedId = reservationTimeRepository.add(new ReservationTime(1, LocalTime.of(1, 1)));
