...
public class Reservation {
    ...
    public static Reservation of(Long id, String name, String date, ReservationTime time) {
        validateEmpty(id, name, date, time);
        LocalDate localDate = parseDate(date);
        return new Reservation(id, name, localDate, time);
    }

    private static void validateEmpty(Long id, String name, String date, ReservationTime time) {
        if (id == null || name == null || name.isEmpty() || date == null || time == null) {
