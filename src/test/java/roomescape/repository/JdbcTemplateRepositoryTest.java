...
class JdbcTemplateRepositoryTest {
    ...
    void 예약이_올바르게_생성된다() {
        ...
        // when
        var saved = repository.create(name, date, time);
    ...
    void 기존에_날짜와_시간이_같은_예약이_있는지_확인() {
        ...
        repository.create(existedName, existedDate, existedTime);
    ...
    void 모든_예약_조회() {
        // given
        repository.create("테스트1", LocalDate.of(2025, 11, 12), LocalTime.of(13, 1));
        repository.create("테스트2", LocalDate.of(2025, 11, 12), LocalTime.of(13, 1));
