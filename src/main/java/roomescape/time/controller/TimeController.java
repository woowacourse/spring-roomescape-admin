...
import roomescape.time.dao.ReservationTimeJdbcDao;
...
public class TimeController {
    ...
    public TimeController(final ReservationTimeJdbcDao reservationTimeJdbcDao) {
        this.reservationTimeJdbcDao = reservationTimeJdbcDao;
    }

    @GetMapping
    public List<TimeResponse> getTime() {
        List<ReservationTime> reservationTimes = reservationTimeJdbcDao.findAllTimes();
    ...
    public void deleteTime(@PathVariable("id") long id) {
        reservationTimeJdbcDao.deleteTime(id);
    }
}
