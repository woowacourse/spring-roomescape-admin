...
class ReservationTest {
    ...
    public static Stream<Arguments> provideEmptyValues() {
        return Stream.of(
            Arguments.of(1L, "", "2024-04-23", new ReservationTime(1L, "10:00")),
            Arguments.of(1L, null, "2024-04-23", new ReservationTime(1L, "10:00")),
            Arguments.of(1L, "jojo", null, new ReservationTime(1L, "10:00")),
            Arguments.of(1L, "jojo", "abc", new ReservationTime(1L, "10:00")),
