...
public class ReservationTimeDaoTest {
    ...
    void 데이터베이스에_예약_시간을_추가할_수_있다() {
        // when & then
        assertThat(reservationTimeDao.insert(new ReservationTime(LocalTime.of(10, 0))))
                .isEqualTo(1);
    }
    ...
    void 데이터베이스에서_예약_시간_목록을_가져올_수_있다() {
        // given
        reservationTimeDao.insert(new ReservationTime(LocalTime.of(9, 0, 0)));
        reservationTimeDao.insert(new ReservationTime(LocalTime.of(10, 0, 0)));

        // when & then
        assertThat(reservationTimeDao.findAll().size())
                .isEqualTo(2);
    }
    ...
    void 데이터베이스의_예약_시간을_삭제할_수_있다() {
        ...
        Long id = reservationTimeDao.findAll().get(0).getId();
