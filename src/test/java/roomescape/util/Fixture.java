...
public class Fixture {
    ...
    public static final ReservationTime JOJO_RESERVATION_TIME_BEFORE_SAVE = ReservationTime.of(0L, JOJO_TIME);
    public static final ReservationTime JOJO_RESERVATION_TIME_AFTER_SAVE = ReservationTime.of(1L, JOJO_TIME);
    public static final ReservationTime GAMJA_RESERVATION_TIME_BEFORE_SAVE = ReservationTime.of(0L, GAMJA_TIME);
    public static final ReservationTime GAMJA_RESERVATION_TIME_AFTER_SAVE = ReservationTime.of(2L, GAMJA_TIME);

    public static final Reservation JOJO_RESERVATION_BEFORE_SAVE = Reservation.of(
        0L,
        JOJO,
        JOJO_DATE,
        JOJO_RESERVATION_TIME_AFTER_SAVE
    );
    public static final Reservation JOJO_RESERVATION_AFTER_SAVE = Reservation.of(
        0L,
        JOJO,
        JOJO_DATE,
        JOJO_RESERVATION_TIME_AFTER_SAVE
    );
    public static final Reservation GAMJA_RESERVATION_BEFORE_SAVE = Reservation.of(
        0L,
        GAMJA,
        GAMJA_DATE,
        GAMJA_RESERVATION_TIME_AFTER_SAVE
    );
    public static final Reservation GAMJA_RESERVATION_AFTER_SAVE = Reservation.of(
        0L,
        GAMJA,
        GAMJA_DATE,
        GAMJA_RESERVATION_TIME_AFTER_SAVE
