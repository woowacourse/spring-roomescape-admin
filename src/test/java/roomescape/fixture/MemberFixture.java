...
public abstract class MemberFixture {
    ...
    public static final long MEMBER_2_ID = 1;
    public static final long MEMBER_3_ID = 1;
    ...
    public static Member newMember(String name) {
        return new Member(name, NOT_EXIST_EMAIL, PASSWORD);
    }
    ...
    public static Member member2() {
        return new Member(MEMBER_2_ID, "solar", MEMBER_2_EMAIL, PASSWORD);
    }

    public static Member member3() {
        return new Member(MEMBER_3_ID, "hotea", MEMBER_3_EMAIL, PASSWORD);
    }

    public static Member newMemberWithoutId() {
        return new Member("newMemberName", NOT_EXIST_EMAIL, PASSWORD);
    }
