...
class ReservationTest {
    ...
    void 이름_날짜_시간으로_예약이_정상적으로_생성된다() {
        ...
        assertThatNoException()
                .isThrownBy(() -> new Reservation(name, date, reservationTime));
    }
    ...
    void ID_이름_날짜_시간으로_예약이_정상적으로_생성된다() {
        ...
        assertThatNoException()
                .isThrownBy(() -> new Reservation(id, name, date, reservationTime));
    }
    ...
    void 이름이_비어있다면_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> new Reservation(id, name, date, reservationTime))
