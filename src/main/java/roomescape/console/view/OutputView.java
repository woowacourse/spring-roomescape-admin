...
public class OutputView {
    ...
    private void printReservation(ReservationResponse reservationResponse) {
        System.out.printf("(%ld) %s | %s | %s",
                reservationResponse.getId(), reservationResponse.getName(), reservationResponse.getDate(), reservationResponse.getTime());
    }

    public void printReservationTimes(List<ReservationTimeResponse> reservationTimeResponses) {
        System.out.println("[방탈출 예약 시간 현황]");
