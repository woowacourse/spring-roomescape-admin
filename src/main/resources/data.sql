...
values ('theme1', 'none', '/image/house.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

insert into theme (name, description, thumbnail, created_date, last_modified_date)
values ('theme2', 'none', '/image/thief.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- 아직 예약이 없는 테마
insert into theme (name, description, thumbnail, created_date, last_modified_date)
values ('no_reservation_theme', 'none', '/image/floors.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- reservation_slot 데이터 삽입
insert into reservation_slot (date, time_id, theme_id, created_date, last_modified_date)
values (CURRENT_DATE - 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

insert into reservation_slot (date, time_id, theme_id, created_date, last_modified_date)
values (CURRENT_DATE - 1, 1, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

insert into reservation_slot (date, time_id, theme_id, created_date, last_modified_date)
values (CURRENT_DATE - 1, 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
