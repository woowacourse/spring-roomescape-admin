...
public class ReservationService {
    ...
    public ReservationResponseV2 save(final ReservationRequestV2 requestV2) {
        ...
        final Reservation2 saved = reservationDao.save(created, findTime.get().getId()); //TODO 리팩터링
        return ReservationResponseV2.from(saved);
    }

    public List<ReservationResponseV2> findAll2() {
        final List<Reservation2> reservations = reservationDao.findAll();
